...
public class CreationEtudiantControler {
	...
	public void ajout(){
		...
		try {
			String sql =" INSERT INTO etudiant (`id`, `name`, `passwrd`, `tel`, `mail`, `firstName`, `fill`, `lvl`) VALUES (NULL,'" + Nom.getText() +"','" + password.getText() +"','" + tel.getText() +"','" + mail.getText() +"','" + prenom.getText() +"','" + fill.getText() +"','" + lvl.getText()+"')";
